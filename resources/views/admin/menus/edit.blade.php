                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.menus.update', $menu->id) }}" enctype="multipart/form-data">
                      ...
                      <div class="sm:col-span-6 pt-5">
                        <label for="number" class="block text-sm font-medium text-gray-700">Price</label>
                        <div class="mt-1">
                          <input type="number" name="price" min="0.00" max="10000.00" step="0.01" id="price" 
                          value="{{ $menu->price }}"
                          class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm"></input>
                        </div>
                        @error('price')
                          <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                      ...
                      <div class="sm:col-span-6 pt-5">
                        ...
                        <div class="mt-1">
                          <textarea id="description" name="description" rows="3" class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm">
                            {{ $menu->description }}
                          </textarea>
                        </div>
                        @error('description')
                      ...
                      <div class="sm:col-span-6 pt-5">
                        <label for="labelcategory" class="block text-sm font-medium text-gray-700">Categories</label>
                        <div class="mt-1">

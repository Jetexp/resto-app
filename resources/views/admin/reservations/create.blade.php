              ...
              <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                  <form method="POST" action="{{ route('admin.reservations.store') }}" >
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-1">
                        <input type="text" id="first_name" name="first_name" class="block w-full sm:text-sm sm:leading-5" />
                      </div>
                      @error('first_name')
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-1">
                        <input type="text" id="last_name" name="last_name" class="block w-full sm:text-sm sm:leading-5" />
                      </div>
                      @error('last_name')
                          <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-1">
                        <input type="email" id="email" name="email" class="block w-full sm:text-sm sm:leading-5" />
                      </div>
                      @error('email')
                          <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-1">
                        <input type="text" id="phone_number" name="phone_number" class="block w-full sm:text-sm sm:leading-5" />
                      </div>
                      @error('phone_number')
                          <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-1">
                        <input type="datetime-local" id="res_date" name="res_date" class="block w-full sm:text-sm sm:leading-5" />
                      </div>
                      @error('res_date')
                          <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-1">
                        <input type="number" id="guest_number"  name="guest_number" class="block w-full sm:text-sm sm:leading-5" />
                      </div>
                      @error('guest_number')
                          <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
